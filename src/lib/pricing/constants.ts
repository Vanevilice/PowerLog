...
export const VLADIVOSTOK_VARIANTS = ['Владивосток (ВМПП)', 'Владивосток (ПЛ)', 'Владивосток (ВМКТ)', 'Владивосток', 'ВМТП/ВМКТ', 'ВМПП/ТА'];
export const VOSTOCHNIY_VARIANTS = ['Восточный', 'Порт Восточный', 'ст. Восточный', 'Восточный порт пк', 'Восточный (ВСК)'];
